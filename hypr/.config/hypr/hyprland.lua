...
local wal_colors = os.getenv("HOME") .. "/.config/hypr/generated/wal-colors.lua"
...
-- Give user services the current Hyprland/Wayland environment
  ...
  -- Start widget controller
  hl.exec_cmd(
      "systemctl --user restart widget-visibility.service"
  )
  end)
...
hl.window_rule({
    match = { class = "firefox" },
    opacity = "1.0 0.93 override",
})

hl.window_rule({
    match = { class = "librewolf" },
    opacity = "0.97 override .93 override",
})
...
--        col = {
--            active_border   = { colors = {"rgba(87a0ffcc)", "rgba(5a78e8cc)"}, angle = 45},
...
-- Window corners, previous: rounding 8, power 2
    decoration = {
        rounding       = 0,
        rounding_power = 2,

        -- Main transparency of focused and unfocused windows
        active_opacity   = .97,
        inactive_opacity = .75,
...
--Hyprlock bind
hl.bind(mainMod .. " + period", hl.dsp.exec_cmd("exec hyprlock"))
...
-- Example special workspace (scratchpad) (disabled for hyprshot region)
